...
class PublishMoodScreen extends StatefulWidget {
  ...
  @override
  _PublishMoodScreenState createState() => _PublishMoodScreenState();
}
...
class _PublishMoodScreenState extends State<PublishMoodScreen> {
  ...
  final List<Map<String, dynamic>> _moodOptions = [
    {
      'score': 10.0, 
      'image': 'assets/images/xinqing/xinqing_1.png', 
      'label': '超开心',
      'defaultText': '今天的心情特别好，阳光明媚，一切都很美好！感谢生活带给我的每一份快乐和惊喜。'
    },
    {
      'score': 8.0, 
      'image': 'assets/images/xinqing/xinqing_2.png', 
      'label': '舒畅',
      'defaultText': '心情舒畅，内心平静而满足。今天的自己状态很好，希望这份美好能够延续下去。'
    },
    {
      'score': 5.0, 
      'image': 'assets/images/xinqing/xinqing_3.png', 
      'label': '一般',
      'defaultText': '今天的心情比较平静，没有特别的起伏。生活就是这样，平平淡淡也是一种幸福。'
    },
    {
      'score': 3.0, 
      'image': 'assets/images/xinqing/xinqing_4.png', 
      'label': '不开心',
      'defaultText': '今天心情有些低落，可能是遇到了一些小困难。相信明天会更好，给自己一些时间调整。'
    },
    {
      'score': 1.0, 
      'image': 'assets/images/xinqing/xinqing_5.png', 
      'label': '难过',
