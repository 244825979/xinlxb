...
class HomeScreen extends StatelessWidget {
  ...
  void _showMoodDialog(BuildContext context, HomeProvider provider) {
    final List<Map<String, dynamic>> moodLevels = [
      {'score': 10.0, 'image': 'assets/images/xinqing/xinqing_1.png', 'label': '超开心'},
      {'score': 8.0, 'image': 'assets/images/xinqing/xinqing_2.png', 'label': '舒畅'},
      {'score': 5.0, 'image': 'assets/images/xinqing/xinqing_3.png', 'label': '一般'},
      {'score': 3.0, 'image': 'assets/images/xinqing/xinqing_4.png', 'label': '不开心'},
      {'score': 1.0, 'image': 'assets/images/xinqing/xinqing_5.png', 'label': '难过'},
    ];
