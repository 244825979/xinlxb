class MoodData {
  ...
  String get moodImage {
    if (moodScore >= 9.0) return 'assets/images/xinqing/xinqing_1.png'; // 超开心
    if (moodScore >= 7.0) return 'assets/images/xinqing/xinqing_2.png'; // 舒畅
    if (moodScore >= 4.0) return 'assets/images/xinqing/xinqing_3.png'; // 一般
    if (moodScore >= 2.0) return 'assets/images/xinqing/xinqing_4.png'; // 不开心
    return 'assets/images/xinqing/xinqing_5.png'; // 难过
  }
